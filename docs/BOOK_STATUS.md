...
> **Current focus:** Repository bootstrap complete; choose the first chapter planning task.
...
| 02 — State, Invariants, and Change | Planned | Chapter 01 helpful but not required | — | — | Create the review plan; this is the blueprint's recommended first drafting task |
...
The blueprint's suggested writing order starts with Chapter 02 rather than Chapter 01. Unless the author chooses strict numeric drafting order, the next action is to instantiate `prompts/chapter-authoring-template.md` for **Chapter 02 — State, Invariants, and Change**.
